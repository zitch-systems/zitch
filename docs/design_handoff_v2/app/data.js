...
window.ZDATA = (function () {
  const NETWORKS = [
    { id: 'mtn', name: 'MTN', color: '#FFCC00', fg: '#0A0A0A', logo: 'assets/logos/mtn.jpg' },
    { id: 'airtel', name: 'Airtel', color: '#E40000', fg: '#fff', logo: 'assets/logos/airtel.svg' },
    { id: 'glo', name: 'Glo', color: '#2BB24C', fg: '#fff', logo: 'assets/logos/glo.jpg' },
    { id: '9mobile', name: '9mobile', color: '#0A8A3D', fg: '#fff', logo: 'assets/logos/9mobile.svg' },
  ];
  ...
  const CABLE = [
    { id: 'dstv', name: 'DSTV', color: '#0A66C2', logo: 'assets/logos/dstv.svg' },
    { id: 'gotv', name: 'GOtv', color: '#92C020', logo: 'assets/logos/gotv.svg' },
    { id: 'startimes', name: 'StarTimes', color: '#F47B20', logo: 'assets/logos/startimes.png' },
  ...
  const BANKS = [
    { id: 'gtb', name: 'GTBank', short: 'GT', tag: 'GTBank', color: '#E35205' },
    { id: 'access', name: 'Access Bank', short: 'AC', tag: 'Access', color: '#00488D' },
    { id: 'zenith', name: 'Zenith Bank', short: 'ZE', tag: 'Zenith', color: '#E2231A' },
    { id: 'uba', name: 'UBA', short: 'UB', tag: 'UBA', color: '#D4122A' },
    { id: 'firstbank', name: 'First Bank', short: 'FB', tag: 'First Bank', color: '#0B4DA2' },
    { id: 'kuda', name: 'Kuda', short: 'KU', tag: 'Kuda', color: '#40196D' },
    { id: 'opay', name: 'OPay', short: 'OP', tag: 'OPay', color: '#1A8E5F' },
    { id: 'palmpay', name: 'PalmPay', short: 'PP', tag: 'PalmPay', color: '#6C2FB3' },
    { id: 'stanbic', name: 'Stanbic IBTC', short: 'ST', tag: 'Stanbic', color: '#00539B' },
    { id: 'fcmb', name: 'FCMB', short: 'FC', tag: 'FCMB', color: '#6B1E74' },
  ];

  // Linked external bank accounts (Mono). la3 is in a re-auth/error state.
  const LINKED = [
    { id: 'la1', bankId: 'gtb', bank: 'GTBank', short: 'GT', tag: 'GTBank', color: '#E35205', acct: '0124454821', name: 'WILLIAM A. ADEYEMI', balance: 84200.10, updated: 'Updated 2m ago', status: 'active' },
    { id: 'la2', bankId: 'access', bank: 'Access Bank', short: 'AC', tag: 'Access', color: '#00488D', acct: '0690847733', name: 'WILLIAM A. ADEYEMI', balance: 215680.00, updated: 'Updated 1h ago', status: 'active' },
    { id: 'la3', bankId: 'kuda', bank: 'Kuda', short: 'KU', tag: 'Kuda', color: '#40196D', acct: '1100021290', name: 'WILLIAM A. ADEYEMI', balance: null, updated: null, status: 'reauth' },
  ];
  ...
  return { NETWORKS, DATA_PLANS, CABLE, CABLE_PLANS, DISCOS, BETTING, EXAMS, BANKS, LINKED, BENEFICIARIES, QUICK_AMTS, TXNS };
})();
