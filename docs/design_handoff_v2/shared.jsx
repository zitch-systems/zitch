...
(function () {
  const P = {
    ...
    unlink: '<path d="M8.6 4.5 9.7 3.4a4.5 4.5 0 0 1 6.4 6.4l-1.1 1.1M15.4 19.5l-1.1 1.1a4.5 4.5 0 0 1-6.4-6.4l1.1-1.1M2 2l20 20"/>',
  };
  ...
  function ZMark({ size = 40, glow = false, badge = false }) {
    if (badge) {
      return React.createElement('img', { src: 'assets/brand/zitch-badge.png', width: size, height: size, alt: 'Zitch',
        style: { borderRadius: '50%', objectFit: 'cover', display: 'block',
          filter: glow ? 'drop-shadow(0 10px 26px rgba(92,245,235,.45))' : 'none' } });
    }
    return React.createElement('img', { src: 'assets/brand/zitch-mark.png', width: size, height: 'auto', alt: 'Zitch',
      style: { display: 'block',
