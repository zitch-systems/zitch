...
window.ZADM = (function () {
  ...
  const PROVIDERS = [
    ...
    { name: 'Wema / ALAT VAS', role: 'Airtime · data · bills', status: 'operational', uptime: '99.91%' },
  ...
  const WEBHOOKS = [
    ...
    { src: 'Wema / ALAT', event: 'transaction.status', ref: 'ZVAS-77231', sig: 'ip + path secret', code: 200, time: ago(410) },
  ];
  const RECONS = [
