...
urlpatterns = [
    ...
    path("txn/reversal-cases/", admin_views.reversal_cases),
    path("txn/reversal-resolution/", admin_views.reversal_resolution),
    path("txn/card-funding-cases/", admin_views.card_funding_cases),
    path("txn/card-funding-resolution/", admin_views.card_funding_resolution),
    path("txn/funding-review-cases/", admin_views.funding_review_cases),
    path("txn/funding-resolution/", admin_views.funding_resolution),
    path("fx/", views.fx),
