...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # An unresolved provider response is never evidence of failure. Keep the
        # debit PENDING and continue alerting until the provider supplies a
        # terminal result; refunding an unknown purchase can double-spend when
        # the service was delivered despite a lost response.
        auto_reversed = 0
