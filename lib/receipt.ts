...
<div class="body">
  ...
  <table>${rows
    ...
    .join('')}</table>
  <div class="wa-promo">
    <div class="wa-kicker">Zitch WhatsApp Banking</div>
    <div class="wa-title">Bank wherever you chat</div>
    <div class="wa-copy">Send money, buy airtime and check your balance securely on WhatsApp.</div>
    <div class="wa-number">${esc(BANK_WHATSAPP_DISPLAY)}</div>
  </div>
</div>
