...
function randomId(): string {
  ...
  // generated by the OS CSPRNG. Twenty random bytes rendered as hex fit the existing
  // fixed 40-character database/index shape.
  return Array.from(Crypto.getRandomBytes(20), byte => byte.toString(16).padStart(2, '0')).join('');
}
